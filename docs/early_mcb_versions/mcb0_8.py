...
"""mcb0_8 Ecoforecast prototype goal is to implement rules base from http://ecoforecast.coral.noaa.gov/index/0/MLRF1/model-detail&name=MASS-CORAL-BLEACHING and 'print' a forecast"""

from pyknow import *
import numpy as np

__author__ = "Madison Soden"
__date__ = "Thu Jan  4 11:05:11 2018"
__license__ = "NA?"
__version__ = "mcb0_8"
...
#test functions to initialize specific combinations of facts
    def declare_facts(self):
        ...
        while(done=='n'):
            ...
            y = input('  ')
            print("""What is the fuzzyTod?( 'even'(0000-0300), 'midn'(0300-0600), 'pdaw'(0600-0900), 'dawn'(0900-1200), 'morn'(1200-1500), 'midd'(1500-1800), 'psun'(2100-2400), 'suns'(2100-2400), 'nite'(0000-0900), 'dayb'(0900-1500), 'aftn'(1800-2400), 'dayl'(0900-2400), 'all'(0300-0300).""")
            z = input('  ')
