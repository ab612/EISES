...
"""mcb0_1 Ecoforecast prototype goal is to implement rules base from http://ecoforecast.coral.noaa.gov/index/0/MLRF1/model-detail&name=MASS-CORAL-BLEACHING and 'print' a forecast"""

from pyknow import *
import numpy as np

__author__ = "Madison Soden"
__date__ = "Thu Dec  7 11:45:35 2017"
__license__ = "NA?"
__version__ = "mcb0_1"
...
"""facts to implement: 
    - Photosynthetically Active Radiation At Ocean Surface (parsurf)
        ~ basic 11 value intensity range
    - 'Tide Level At ~1m Depth (tide1m)'
        ~basic 11 value intensity range
    - 'Hourly Average Wind Speed (windsp)'
        ~basic 11 value intensity ranges
    - 'Depth-Averaged Sea Temperature (seandbc)'
        ~basic 11 value intensity ranges
    - Sea Temperature At ~1m Depth (sea1m) 
        ~ basic 11 value intensity
    - 'Remss 'misst' Blended Microwave/infrared Sst (sst)'
        ~ basic 11 value intensity ranges
    - '3-Day Average Wind Speed (windsp 3day)'
        ~basic 11 value intensity
    - 'Berkelmans Temperature-Duration Bleaching Curve (bleaching Curve)'
        ~unsure, can contain values 'Conductive', and  'Very-Conductive'
    - 'Monthly Mean Sea Temperature At ~1m Depth (sea1m Monthly)'
        ~basic 11 value intensity 
    - Monthly Mean Depth-Averaged Sea Temperature (seandbc Monthly)'
        ~ basic 11 value intensity range"""
...
class GCoralBleaching(KnowledgeEngine):
#General Coral Bleaching Forecast
