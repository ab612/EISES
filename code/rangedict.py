...
7fuzzy= ['dlow', 'vlow', 'low', 'average', 'high', 'vhigh', 'dhigh']
...
rnges['mlrf1']['surfbarom']= [[ 980, 990, 100, 1005, 1010, 1020, 1025, 1030, 1035, 1040], standardfuzzy]
...
ranges['mlrf1']['BseaT']= [[ 8, 12, 14, 16, 30.4, 31.4, 32.4, 34], 7fuzzy]
...
ranges['mlrf1']['satChlorA']= [[ 0.01, 0.1, 0.2, 0.5, 0.7, 1.2, 1.4, 2, 4, 6], stamdardfuzzy]
